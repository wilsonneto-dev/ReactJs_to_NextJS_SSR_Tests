      ...
      <>
        ...
        <div className="wrapper-about inner">
          ...
          <p>
            ...
            Artes foi inaugurado em julho de 1967 com o filme de abertura “Os
            Russos Estão Chegando”, programado pela Sociedade Amigos da
            Cinemateca. Em 1980 ganhou a divisão de seis salas, existente até
            hoje, batizadas cada uma com o nome de um artista brasileiro:
            Villa-Lobos, Candido Portinari, Oscar Niemeyer, Aleijadinho, Mario
            de Andrade e Carmen Miranda. Devido a sua programação especial,
            mesclando filmes de nacionalidades diversas e mantendo alguns filmes
            por longo período em cartaz, o Cine Belas Artes tornou-se um dos
            mais importantes pontos de encontro intelectual e artístico da
            cidade.
            <br />
            Desde Maio de 2019, o cinema é patrocinado pela cerveja Petra, do
            Grupo Petrópolis, se tornando Petra Belas Artes.
          </p>
